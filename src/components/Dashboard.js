...
export function Dashboard({ users1 }) {
  ...
  return (
    ...
    <div className='content'>
      <div className='svgs'>
        ...
        {/*body area - welcome message and main-content  */}
      <div className="Body">
        <section className='welcome'>
          <h1>Welcome ADMIN!!!</h1>
        </section>
        <section className='mainContent'>
          <MainContentDash users1={users1} />
        </section>
      </div>
    </div>
  );
